...
export class Desktop extends Component {
    ...
    componentDidMount() {
        ...
        this.fetchAppsData(); //app registry
        this.setContextListeners(); //context menu
        this.setEventListeners(); //DOM listeners 
        this.checkForNewFolders(); //user created folders from local storage 
    }

    componentWillUnmount() {
        this.removeContextListeners(); //prevents leaks 
    }
